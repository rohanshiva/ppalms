...
const GenerationForm = (props: any) => {
  ...
  return (
    <div>
      ...
      <button style={{"marginLeft" : "1rem"}} onClick={() => history.replace('/select-lines', {"prevState" : props.location.state.editorState, "prevProps": props.location.state.editorProps})}>👈🏿</button>
